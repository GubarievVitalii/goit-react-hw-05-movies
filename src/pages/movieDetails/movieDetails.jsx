...
const MovieDetails = () => {
    ...
    return (
        <div className={s.movieDetails}>
            {data &&
                <>
                <button className={s.movieDetails_btn} onClick={()=> navigate(location.state ?? "/")}>
                    ...
                    <ul><li>
                        <Link state={location.state} className={s.movieDetails_link} to={`/movies/${movieId}/cast`}>Cast</Link>
                    </li>
                        <li>
                            <Link state={location.state} className={s.movieDetails_link} to={`/movies/${movieId}/reviews`}>Reviews</Link>
                        </li>
                </ul>
